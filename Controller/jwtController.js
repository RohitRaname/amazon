...
const handleUserPasswordChanged = tryCatch(

  async (res, user, decodedToken) => {
...
const blackListUserIfTokenInvalidPassesMaxTries = tryCatch(async (
  res,
  user,
  token,
  refreshJwt
...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (jwt && !refreshJwt) return await handleStolenJwt(req, res);
