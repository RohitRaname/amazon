...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../View/main.js":[function(require,module,exports) {
// import './Form/SignUp/0.CreateAccountView.js';
// import './Form/SignUp/1.CustomiseExperienceView.js';
// import './Form/SignUp/2.ConfirmAccountCredentialsView.js';
// import './Form/SignUp/3.SignUpVerificationView.js';
// import './Form/SignUp/4.SetPasswordView.js';
// import './Form/SignUp/5.SetProfileView.js';
// import './Form/SignUp/6.SetBioView.js';
// import './Form/Login/0.LoginWithNameOrEmailView.js';
// import './Form/Login/1.ConfirmLoginView.js';
// import './Form/ForgotPassword/0.FindAccountView.js';
// import './Form/ForgotPassword/1.SendResetPasswordTokenView.js';
// import './Form/ForgotPassword/2.ResetPasswordView.js';
...
var _default = new TwitterJoinPage();
...
if (twitterJoinUpPage) _twitterJoinPageView.default.handlePage();
...
var FormView = /*#__PURE__*/function () {
  ...
  _createClass(FormView, [{
    ...
    value: function _activeGroupEl(formGroupEl, active) {
      var groupEls = this._getGroupEls();
    ...
    value: function _unActiveAllGroupEls() {
      var groupEls = this._getGroupEls(this._parentEl);
    ...
    key: "_handleCloseForm",
    value: function _handleCloseForm(target) {
      if (!(0, _domHelper.closest)(target, 'form-closeBtn')) return;
    ...
    key: "_handleGroupElDropdown",
    value: function _handleGroupElDropdown(target) {
    ...
    value: function _enableSubmitBtnWhenAllInputsValid() {
      ...
      this._parentEl.addEventListener('input', function () {
        var inputEls = _this._getInputEls().filter(function (el) {
          return !(0, _domHelper.contains)(el.closest('.form-group'), 'hidden');
        });
        ...
        _this._parentEl.dataset.allInputFieldsValid = valid;
        if (valid) _this._parentEl.querySelector('.form-submitBtn').disabled = false;else _this._parentEl.querySelector('.form-submitBtn').disabled = true;
      });
    } // Main function
    ...
    value: function _basicFormClickAndInputEvent(e) {
      ...
      this._handleCloseForm(target); // handle option selected in group El dropdown


      this._handleGroupElDropdown(target); // make group look as they have been filled by using css
    ...
    value: function handleCheckBox(checkBoxBtn, submitBtn) {
      checkBoxBtn.addEventListener('click', function () {
        ...
        if (checked === 'true') submitBtn.disabled = false;else submitBtn.disabled = true;
      });
    }
  }]);
...
var CreateAccountView = /*#__PURE__*/function (_FormView) {
  ...
  function CreateAccountView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_phoneGroupEl", _this._parentEl.querySelector('.form-group[data-field="phone"]'));

    _defineProperty(_assertThisInitialized(_this), "_inputPhoneEl", _this._phoneGroupEl.querySelector('#phone'));

    _defineProperty(_assertThisInitialized(_this), "_inputPhoneErrorEl", _this._phoneGroupEl.querySelector('.form-error'));
    ...
    _this._updateNameInputWordCount();

    _this._checkPhoneNumber();

    _this._checkName();

    _this._checkEmail();

    _this._switchBetweenPhoneAndEmail(); // this._clearAllInputElValue();
  ...
  _createClass(CreateAccountView, [{
    ...
    key: "_checkPhoneNumber",
    value: function _checkPhoneNumber() {
      var _this2 = this;

      this._inputPhoneEl.addEventListener('input', function (e) {
        var checker = /^(1\s|1|)?((\(\d{3}\))|\d{3})(\-|\s)?(\d{3})(\-|\s)?(\d{4})$/;
        var value = e.target.value.trim();
        if (value.length === 0) return _this2._phoneGroupEl.dataset.error = false;
        var isValid = checker.test(value);
        if (isValid) return _this2._phoneGroupEl.dataset.error = false;
        _this2._phoneGroupEl.dataset.error = true;
      });
    }
  }, {
    key: "_checkName",
    value: function _checkName() {
      ...
      this._inputNameEl.addEventListener('input', function (e) {
        var value = e.target.value.trim();
        if (value.length === 0) return _this3._nameGroupEl.dataset.error = true;
        if (value.length > 0) return _this3._nameGroupEl.dataset.error = false;
      });
    }
  }, {
    key: "_checkEmail",
    value: function _checkEmail() {
      ...
      this._inputEmailEl.addEventListener('input', function (e) {
        var value = e.target.value.trim();
        if (value.length === 0) return _this4._emailGroupEl.dataset.error = false;
        if (!value.includes('@gmail.com' || '.io' || '.com')) return _this4._emailGroupEl.dataset.error = true;
        _this4._emailGroupEl.dataset.error = false;
      });
    }
  }, {
    key: "_switchBetweenPhoneAndEmail",
    value: function _switchBetweenPhoneAndEmail() {
      var _this5 = this;

      this._switchBetweenPhoneAndEmailBtn.addEventListener('click', function (e) {
        var switchTo = e.target.dataset.switchTo;
        console.log(switchTo);

        if (switchTo === 'email') {
          (0, _domHelper.removeClass)(_this5._emailGroupEl, 'hidden');
          (0, _domHelper.addClass)(_this5._phoneGroupEl, 'hidden');
          _this5._switchBetweenPhoneAndEmailBtn.dataset.switchTo = 'phone';
          _this5._switchBetweenPhoneAndEmailBtn.textContent = 'Use Phone instead';
          return;
        }

        (0, _domHelper.addClass)(_this5._emailGroupEl, 'hidden');
        (0, _domHelper.removeClass)(_this5._phoneGroupEl, 'hidden');
        _this5._switchBetweenPhoneAndEmailBtn.dataset.switchTo = 'email';
        _this5._switchBetweenPhoneAndEmailBtn.textContent = 'Use Email instead';
      });
    } // API ***********************************************
    ...
    value: function addHandlerSubmitForm(handle) {
      ...
      this._formSubmitBtn.addEventListener('click', function () {
        var formData = _this6.getAllNonHiddenInputValueAsFormData();
...
exports.default = _default;
},{"../../Common/FormView.js":"../../View/Common/FormView.js","../../utils/domHelper.js":"../../View/utils/domHelper.js"}],"../../../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../../../node_modules/axios/lib/axios.js"}],"../../Controller/api/api.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.post = exports.patch = exports.get = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return _axios.default[method]({
              url: "".concat(api, "/").concat(route),
              data: body
            });
          ...
          case 7:
            ...
            'handle error show some small modal message';
...
var post = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(route, body) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return makeReq('POST', route, body);
...
var patch = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(route, body) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return makeReq('PATCH', route, body);
...
exports.patch = patch;
},{"axios":"../../../node_modules/axios/index.js"}],"../../Controller/Components/Form/SignUp/0.CreateAccountView.js":[function(require,module,exports) {
"use strict";
...
},{"../../../../View/Form/SignUp/0.CreateAccountView.js":"../../View/Form/SignUp/0.CreateAccountView.js","../../../api/api.js":"../../Controller/api/api.js"}],"../../Controller/main.js":[function(require,module,exports) {
"use strict";

require("./Pages/twitterJoinPage.js");

require("./Components/Form/SignUp/0.CreateAccountView.js");
},{"./Pages/twitterJoinPage.js":"../../Controller/Pages/twitterJoinPage.js","./Components/Form/SignUp/0.CreateAccountView.js":"../../Controller/Components/Form/SignUp/0.CreateAccountView.js"}],"../../script.js":[function(require,module,exports) {
"use strict";

require("./View/main.js");

require("./Controller/main.js");
},{"./View/main.js":"../../View/main.js","./Controller/main.js":"../../Controller/main.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/script.06b7cfbd.js.map